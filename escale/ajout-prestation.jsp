            ...
            <table class="table mt-3">
                ...
                <% for (Prestation prestation : escale.getListePrestation()) { %>
                    <tr>
                        ...
                        <td><a href=""><svg xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 -960 960 960" width="48"><path d="M378-246 154-470l43-43 181 181 384-384 43 43-427 427Z"/></svg></a></td>
